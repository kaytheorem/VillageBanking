<div class="geex-sidebar">
    ...
    <div class="geex-sidebar__wrapper">
                ...
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu">
                        <li class="geex-sidebar__menu__item">
                            <a href="{{ route('my.groups') }}" class="geex-sidebar__menu__link geex-customizer__btn--top">All Groups
                                </a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="{{ route('add.group') }}" class="geex-sidebar__menu__link geex-customizer__btn--side">Create Group</a>
                        </li>
        ...
        <div class="geex-sidebar__footer">
            <span class="geex-sidebar__footer__title">Village Bank Modern Dashboard</span>
