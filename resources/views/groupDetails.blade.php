        ...
        <div class="geex-content">
            <div class="geex-content__header">
                <div class="geex-content__header__content">
                    <h2 class="geex-content__header__title">{{ $group->name }} </h2>
                </div>
            ...
            <div class="geex-content__wrapper">
                <div class="geex-content__section-wrapper">
                    ...
                    <!-- Tab Content -->
                    <div id="members" class="tab-content">Members content goes here.</div>
                    <div id="savings" class="tab-content" style="display:none;">Savings content goes here.</div>
                    <div id="loans" class="tab-content" style="display:none;">Loans content goes here.</div>
                    <div id="balance" class="tab-content" style="display:none;">Balance content goes here.</div>
                    <div id="constitution" class="tab-content" style="display:none;">Constitution content goes here.
                    </div>
                </div>
            </div>
