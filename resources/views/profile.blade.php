                                ...
                                <div class="card-body">
                                    <div class="align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            class="rounded-circle avatar-xxl img-thumbnail float-start" alt="Profile Image">
                                                    ...
                                                    <div class="card border mb-0">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3 row">
                                                                ...
                                                                <div class="col-lg-12 col-xl-12">
                                                                    <input class="form-control" type="text" name="location" value="{{ old('location', $user->location) }}" placeholder="Enter your location">
                                                                </div>
                                                            </div>
